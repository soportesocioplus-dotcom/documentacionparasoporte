...
description: >-
  ...
  instalación del molinete con control de acceso por llaveros/tarjetas.
icon: key
---

# Instalación de molinete con llaveros

Este documento describe el procedimiento de instalación y configuración del control de acceso por llaveros o tarjetas, que opera mediante una base de datos local en Microsoft Access y controla el molinete a través de un puerto serie (COM). Está dirigido al equipo de soporte técnico encargado de realizar la instalación en la sede del cliente.
